...
def test_get_annos():
    ...
    # print("Annos:", annos)
    assert len(annos) == 2
    assert annos[0] == "/io/Lambda/tests/unit_tests" + \
        "/test_data/2019/4-10/0242ac120002-detection-1564068022219-2.jpeg.xml"
    assert annos[1] == "/io/Lambda/tests/unit_tests" + \
        "/test_data/2019/4-10/0242ac120002-detection-1564068022219-1.jpeg.xml"
...
def test_annos_to_csv():
    ...
    with patch('update.helpers.time') as mock_time:
        ...
        annos_to_csv("/io/Lambda/tests/unit_tests/test_data/2019/",
...
# def test_annos_to_csv_ACTUAL_FILE_OUT():
...
#     annos_to_csv("/AZIZ_DATA/2020/", "object-detection-models-training-data")
